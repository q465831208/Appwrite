...
const UUID = process.env.UUID || 'b23ddeeb-aa0a-4167-a032-64224ed85180';  
...
const TUIC_PORT = process.env.TUIC_PORT || 51025;           
const HY2_PORT = process.env.HY2_PORT || 51026;             
const REALITY_PORT = process.env.REALITY_PORT || 51027;     
...
const FRP_IP = process.env.FRP_IP || '89.106.78.234';                 
const FRP_PORT = process.env.FRP_PORT || '51023';         
